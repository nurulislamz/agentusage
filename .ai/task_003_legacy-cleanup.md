# Task: T3 — Remove status-line coupling and prepare migration

## Context

- Repository: `/home/nurul/agentusage`
- Role: `delegated-executor`
- Plan: [Usage simplification](../docs/superpowers/plans/2026-09-05-usage-simplification.md) — section “T3 — Remove status-line coupling and prepare migration”.
