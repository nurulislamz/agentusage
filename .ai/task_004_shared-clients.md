# Task: T4 — Make every presentation consume shared usage

## Context

- Repository: `/home/nurul/agentusage`
- Role: `delegated-executor`
- Plan: [Usage simplification](../docs/superpowers/plans/2026-09-05-usage-simplification.md) — section “T4 — Make every presentation consume shared usage”.
- Dependency order: T2, T3.
