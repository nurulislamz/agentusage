# Task: T2 — One daemon polling and lifecycle path

## Context

- Repository: `/home/nurul/agentusage`
- Role: `delegated-executor`
- Plan: [Usage simplification](../docs/superpowers/plans/2026-09-05-usage-simplification.md) — section “T2 — One daemon polling and lifecycle path”.
- Dependency order: T1.
