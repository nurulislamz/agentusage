# Task: T5 — Smaller command help, migration UX and documentation

## Context

- Repository: `/home/nurul/agentusage`
- Role: `delegated-executor`
- Plan: [Usage simplification](../docs/superpowers/plans/2026-09-05-usage-simplification.md) — section “T5 — Smaller command help, migration UX and documentation”.
- Dependency order: T4.
