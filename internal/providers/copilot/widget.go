...
func dashboardWidget() core.DashboardWidget {
	return providerbase.CodingToolDashboard(
		...
		providerbase.WithCompactRows(
			...
			core.DashboardCompactRow{Label: "Usage", Keys: []string{"context_window", "tokens_today", "7d_tokens"}, MaxSegments: 3},
			core.DashboardCompactRow{Label: "Rate", Keys: []string{"gh_core_rpm", "gh_search_rpm", "gh_graphql_rpm"}, MaxSegments: 3},
			core.DashboardCompactRow{Label: "Activity", Keys: []string{"messages_today", "sessions_today", "total_prompts"}, MaxSegments: 4},
		...
		providerbase.WithHideMetricKeys(
			...
			"cli_messages", "cli_turns", "cli_sessions", "cli_response_chars", "cli_reasoning_chars",
		),
		providerbase.WithRawGroups(
			core.DashboardRawGroup{
				Label: "Usage Split",
				Keys: []string{
					"model_usage", "client_usage", "model_turns", "model_sessions",
