...
- `fetchLatestReleaseVersion(...)` against GitHub Releases API:
  - `https://api.github.com/repos/nurulislamz/openusage/releases/latest`
...
- Homebrew: `brew upgrade nurulislamz/tap/openusage`
- Go install: `go install github.com/nurulislamz/openusage/cmd/openusage@latest`
- Install script: `curl -fsSL https://github.com/nurulislamz/openusage/releases/latest/download/install.sh | bash`
