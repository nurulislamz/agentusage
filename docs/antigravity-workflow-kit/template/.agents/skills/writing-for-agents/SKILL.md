...
**Antigravity note:** Prefer Antigravity skill frontmatter fields (`name`, `description`, optional `disable-slash-command`). Ignore Claude-only installer paths like `/setup-matt-pocock-skills` unless that skill is actually installed.
